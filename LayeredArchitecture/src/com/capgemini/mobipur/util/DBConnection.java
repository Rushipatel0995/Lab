...
public class DBConnection {
	...
	/*************************************************************************************
	 * - @throws MobilePurchaseException - Private Constructor - Author : CAPGEMINI -
	 * Creation Date : 18/11/2016 - Desc:Loads the jdbc.properties file and
	 * Driver Class and gets the connection
	 ***************************************************************************************/
	 ...
	 * :DBConnection instance - Throws : MobilePurchaseException - Author : CAPGEMINI -
	 * Creation Date : 18/11/2016 - Description : Singleton and Thread safe
	 * class
	 *******************************************************************/
	...
	/*****************************************************************
	 * - Method Name:loadProperties() - Input Parameters : - Return Type
	 * :Properties object - Author : CAPGEMINI - Creation Date : 18/11/2016 -
	...
	private Properties loadProperties() throws IOException {
		...
		if (props == null) {
			...
			String fileName = "resourses/jdbc.properties";
	 ...
	 * :OracleDataSource object - Author : CAPGEMINI - Creation Date :
	 * 18/11/2016 - Description : Returns OracleDataSource object
	 *******************************************************************/
